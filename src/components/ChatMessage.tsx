...
interface ChatMessageProps {
  message: ChatMessageType | { id: string; type: "assistant"; content: string; timestamp: Date };
  isLast?: boolean;
...
export const ChatMessage: React.FC<ChatMessageProps> = ({ message, isLast = false, isFirstUserMessage = false }) => {
  return (
    <Box
      sx={{
        mb: isLast ? 8 : 3,
